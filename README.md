...
Pierwszy argumentem jest literowa nuta (od C0 do B8, dźwięki podwyższone zonaczamy z krzyżykiem np. D#3)
...
Kolejną konstrukcją jest prosta pętla `repeat {ile razy} times {nuta|funkcja}` oznaczająca powórzenie nuty lub funkcji wskazaną liczbę razy.
